...
parser.add_argument('--batch_size', type=int, default=64, help='batch size for training and validation (default: 50)')
parser.add_argument('--epochs', type=int, default=20, help='epochs for training  (default: 50)')
parser.add_argument('--num_layers', type=int, default=9, help='number of layers')
parser.add_argument('--window', type=int, default=50, help='window length')
parser.add_argument('--sensorsfilepath', type=str, default='../data/METR-LA/graph_sensor_ids.txt', help='sensors file path')
parser.add_argument('--disfilepath', type=str, default='../data/METR-LA/distances_la_2012.csv', help='distance file path')
parser.add_argument('--tsfilepath', type=str, default='../data/METR-LA/metr-la.h5', help='ts file path')
